...
superseded-by: kart-physics.md (v2.4 — emergent slip-angle model)
---

# Kart Physics System (v2.3 — ARCHIVED)

> **Status**: Archived 2026-04-22 — superseded by v2.4 emergent slip-angle model
> **Reason for archival**: Input-driven intensity created feedback loops (first-lap oval), artificial lateral ramp felt like "kick", no stable circular drift. Replaced by measurement-based intensity via atan2(side_speed, fwd_speed).
>
> **Original v2.3 Status**: Active (continuous intensity_target from pow(|steer|, exponent))
