...
DEV_TO_TRES = {
    ...
    # Bicycle v3.0
    "WHEELBASE_OVERRIDE": "wheelbase_override",
    "TRACK_WIDTH_OVERRIDE": "track_width_override",
    "MAX_STEER_ANGLE_DEG": "max_steer_angle_deg",
    "FRONT_GRIP": "front_grip_stiffness",
    "REAR_GRIP": "rear_grip_stiffness",
    "TIRE_SATURATION": "tire_saturation_speed",
    "INERTIA_SCALE": "inertia_scale",
    "OMEGA_DAMPING": "omega_damping",
    "STATIONARY_OMEGA_KICK": "stationary_omega_kick",
    "DRIFT_MAX_SLIP_SPEED": "drift_max_slip_speed",
    "OMEGA_LEAN_SCALE": "omega_lean_scale",
    # Drift signal shaping (still active)
