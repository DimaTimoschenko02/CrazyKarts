...
| Kart Physics | `kart-physics.md` | **v2.2 implemented; v2.3 GDD active, code pending** (branch: `arcade-physics`). v2.3: continuous `intensity_target = pow(\|steer\|, exponent) * speed_factor` replaces binary hysteresis; `DRIFT_STEER_EXPONENT=3.0` new knob; thresholds removed. v2.1, v2.2 archived. |
