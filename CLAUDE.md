...
| Kart Physics | `kart-physics.md` | **v2.2 Implemented, testing pending** (branch: `arcade-physics`). Continuous `_drift_intensity` model, lateral ramp (replaces kick), lerp multipliers. v2.1 archived at `kart-physics-v2.1-archive.md`. |
