...
| Kart Physics | `kart-physics.md` | **Implemented v2 arcade** (branch: `arcade-physics`, not playtested). Binary drift + hysteresis, direct rotation, force-based inertia. 2026-04-21. |
