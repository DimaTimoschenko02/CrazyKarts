...
| Kart Physics | `kart-physics.md` | Refactoring v2 arcade (branch: `arcade-physics`). GDD updated 2026-04-20: binary drift + hysteresis, direct rotation, force-based inertia. Code in progress per `docs/superpowers/plans/2026-04-20-arcade-physics-refactor.md` |
