...
| Kart Physics | `kart-physics.md` | **GDD v2.1 designed, code pending** (branch: `arcade-physics`). Binary drift + hysteresis, direct rotation, force-based inertia + drift resistance (DRIFT_DRAG_MULTIPLIER / DRIFT_ROLLING_MULTIPLIER). Impl by gameplay-programmer. |
